...
sudo apt-get install -y software-properties-common python-dev python-pip python3-dev python3-pip \
    neovim stow i3 compton zsh curl dunst neofetch htop clipit plank rbenv tmux tmuxinator \
    ...
    jmtpfs mtp-tools scrot curl gnome-tweak-tool unclutter fzf touchegg pavucontrol

# watchman libxcbl-dev tsserver
